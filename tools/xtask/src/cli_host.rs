...
const CLI_OPERATION_METADATA: &[CliOperationMetadata] = &[
    ...
    meta(
        ...
        "TradeProposalSubmit",
        "radroots trade proposal submit <file>",
        "Submit a trade proposal from a complete candidate draft.",
        "Buyer",
        false,
    ),
    meta(
        "trade.revision.propose",
        "TradeRevisionPropose",
        "radroots trade revision propose <file>",
        "Propose a complete replacement candidate for a trade.",
        "Any",
        false,
    ),
    meta(
        "trade.candidate.decide",
        "TradeCandidateDecide",
        "radroots trade candidate decide <file>",
        "Decide a candidate proposal.",
        "Any",
        false,
    ),
    meta(
        "trade.cancellation.submit",
        "TradeCancellationSubmit",
        "radroots trade cancellation submit <file>",
        "Submit a trade cancellation mutation.",
        "Any",
        false,
    ),
    meta(
        "trade.operation.resume",
        "TradeOperationResume",
        "radroots trade operation resume <file>",
        "Resume a prepared trade operation envelope.",
        "Any",
        false,
    ),
    meta(
        ...
        "Get SDK trade projection details.",
        "Any",
        false,
    ),
    meta(
        ...
        "TradeList",
        "radroots trade list",
        "List SDK trade projections.",
        "Any",
        true,
    ),
    meta(
        "trade.evidence.refresh",
        "TradeEvidenceRefresh",
        "radroots trade evidence refresh <trade-id>",
        "Refresh SDK trade evidence projections.",
        "Any",
        false,
    ),
    meta(
        "trade.evidence.inspect",
        "TradeEvidenceInspect",
        "radroots trade evidence inspect <trade-id>",
        "Inspect protected trade evidence metadata.",
        "Any",
        true,
    ),
    meta(
        "trade.private_artifact.seal",
        "TradePrivateArtifactSeal",
        "radroots trade private-artifact seal <trade-id>",
        "Seal a protected private trade artifact.",
        "Any",
        false,
    ),
    meta(
        "trade.private_artifact.open",
        "TradePrivateArtifactOpen",
        "radroots trade private-artifact open <artifact-id>",
        "Open a protected private trade artifact.",
        "Any",
        false,
    ),
    meta(
        "trade.private_artifact.delete",
        "TradePrivateArtifactDelete",
        "radroots trade private-artifact delete <artifact-id>",
        "Delete a protected private trade artifact.",
        "Any",
        false,
    ),
    meta(
