...
pub const RUNTIME_OPERATION_DESCRIPTORS_V1: &[RuntimeOperationDescriptorV1] = &[
    ...
    mutation(
        RuntimeOperationIdV1::TradeProposalSubmit,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::Required,
        TransportCapabilityRouteV1::delivery(),
    ...
    mutation(
        RuntimeOperationIdV1::TradeRevisionPropose,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::Required,
        TransportCapabilityRouteV1::delivery(),
    ...
    mutation(
        RuntimeOperationIdV1::TradeCandidateDecide,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::Required,
        TransportCapabilityRouteV1::delivery(),
    ...
    mutation(
        RuntimeOperationIdV1::TradeCancellationSubmit,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::Required,
        TransportCapabilityRouteV1::delivery(),
    ...
    mutation(
        RuntimeOperationIdV1::TradeOperationResume,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::Required,
        TransportCapabilityRouteV1::delivery(),
    ...
    mutation(
        RuntimeOperationIdV1::TradeEvidenceRefresh,
        OperationRiskV1::Medium,
        ApprovalRequirementV1::None,
        SignerRequirementV1::None,
        TransportCapabilityRouteV1::local(),
    ...
    read(
        RuntimeOperationIdV1::TradeEvidenceInspect,
        OperationRiskV1::Low,
        TransportCapabilityRouteV1::local(),
        PrivacyEffectV1::PrivateCoordination,
        ProjectionEffectV1::ReadsProjection,
    ...
    mutation(
        RuntimeOperationIdV1::TradePrivateArtifactSeal,
        OperationRiskV1::High,
        ApprovalRequirementV1::ConditionalOrRequiredByMode,
        SignerRequirementV1::None,
        TransportCapabilityRouteV1::local(),
    ...
    read(
        RuntimeOperationIdV1::TradePrivateArtifactOpen,
        OperationRiskV1::High,
        TransportCapabilityRouteV1::local(),
        PrivacyEffectV1::PrivateCoordination,
        ProjectionEffectV1::ReadsProjection,
    ...
    mutation(
        RuntimeOperationIdV1::TradePrivateArtifactDelete,
        OperationRiskV1::Critical,
        ApprovalRequirementV1::Required,
        SignerRequirementV1::None,
        TransportCapabilityRouteV1::local(),
