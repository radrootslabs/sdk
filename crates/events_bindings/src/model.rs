...
const EVENT_KIND_EXPORTS: &[(&str, u32)] = &[
    ...
    (
        ...
        kinds::KIND_TRADE_LISTING_VALIDATION_REQUEST,
    ),
    (
        "KIND_TRADE_LISTING_VALIDATION_RESULT",
        kinds::KIND_TRADE_LISTING_VALIDATION_RESULT,
    ),
    (
    ...
    (
        ...
        kinds::KIND_TRADE_TRANSITION_PROOF_RESULT,
    ),
    ("KIND_ORDER_REQUEST", kinds::KIND_ORDER_REQUEST),
    ("KIND_ORDER_DECISION", kinds::KIND_ORDER_DECISION),
    (
        "KIND_ORDER_REVISION_PROPOSAL",
        kinds::KIND_ORDER_REVISION_PROPOSAL,
    ),
    (
        "KIND_ORDER_REVISION_DECISION",
        kinds::KIND_ORDER_REVISION_DECISION,
    ),
    ("KIND_ORDER_CANCELLATION", kinds::KIND_ORDER_CANCELLATION),
