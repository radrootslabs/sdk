...
#[cfg(feature = "std")]
const LOCAL_RELAY_SCHEME_ENV: &str = "RADROOTS_LOCAL_NOSTR_RELAY_PUBLIC_SCHEME";
#[cfg(feature = "std")]
const LOCAL_RELAY_HOST_ENV: &str = "RADROOTS_LOCAL_NOSTR_RELAY_PUBLIC_HOST";
#[cfg(feature = "std")]
const LOCAL_RELAY_PORT_ENV: &str = "RADROOTS_LOCAL_NOSTR_RELAY_PUBLIC_PORT";
#[cfg(feature = "std")]
