...
export const KIND_TRADE_LISTING_VALIDATION_REQUEST = 5321;

export const KIND_TRADE_LISTING_VALIDATION_RESULT = 6321;

export const KIND_TRADE_TRANSITION_PROOF_REQUEST = 5322;

export const KIND_TRADE_TRANSITION_PROOF_RESULT = 6322;

export const KIND_ORDER_REQUEST = 3422;

export const KIND_ORDER_DECISION = 3423;

export const KIND_ORDER_REVISION_PROPOSAL = 3424;

export const KIND_ORDER_REVISION_DECISION = 3425;

export const KIND_ORDER_CANCELLATION = 3432;
