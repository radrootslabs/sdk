...
export const KIND_TRADE_PROPOSAL = 3470;

export const KIND_TRADE_DECISION = 3471;

export const KIND_TRADE_REVISION_PROPOSAL = 3472;

export const KIND_TRADE_REVISION_DECISION = 3473;

export const KIND_TRADE_CANCELLATION = 3474;

export const KIND_TRADE_SELLER_RESERVATION_ASSERTION = 3475;
